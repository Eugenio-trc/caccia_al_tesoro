...
import com.demo.bankapp.response.ResponseFantastica;
...
public class WealthController {
	...
	public ResponseFantastica retrieveWealth(@RequestBody RetrieveWealthRequest request) {
		...
		ResponseFantastica response = new ResponseFantastica();
